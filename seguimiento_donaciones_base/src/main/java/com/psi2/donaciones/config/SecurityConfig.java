    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthFilter jwtAuthFilter, RateLimitFilter rateLimitFilter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/**","/api/metricas","/api/solicitudes/aprobadas/almacen","api/solicitudes/aceptar-ayuda/**","/api/solicitudes-sin-responder/inventario", "/api/donaciones/donantes", "/api/usuarios/**", "/api/solicitudes-sin-responder/crear-completa","/api/solicitudes/apoyo","/images/**","/ws/**","/proxy/**").permitAll()
